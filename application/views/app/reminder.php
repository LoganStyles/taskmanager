...
//                                    $content.="<td>$date_created</td>";
                            ...
                            <div class="form-group ">
                                <div class="col-sm-12">
                                    <?php
                                    $buttons = "<a href=\"" . base_url() . "index.php/app/showReminder/0/" . $type . "/form_" . "\"class=\"btn btn-default  \" type=\"button\"><i class=\"fa fa-plus\"></i>&nbsp;New</a>&nbsp;";//                    
                                    if ($count > 1) {
                                        $buttons.="<a onclick=\"remindermanager('view_');\" type=\"button\" class=\"btn btn-primary \"><i class=\"fa fa-eye\"></i>&nbsp;View</a>&nbsp;";
                                        $buttons.="<a onclick=\"remindermanager('form_');\" type=\"button\" class=\"btn btn-success \"><i class=\"fa fa-edit\"></i>&nbsp;Edit</a>&nbsp;";                                        
                                    }
                                    echo $buttons;
                                    ?>
